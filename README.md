Harish Sen, Harish Joshi, Hari Prasad, HimaBindu	>> Team project

https://github.com/harishmsgit/herovired-infra	     Completed-4. End-to-End Pipeline with ShopNow service, Infra service												   											
	https://github.com/harishmsgit/shopNow																								
---------------------------------------------------------------------------------------------------------------------
Capstone Project Title: End-to-End DevOps Pipeline for a Web Application with CI/CD
